...
> tl;dr 摩茲工寮在 2022/5～2023/6 間共承接 183 場開放文化活動及聚會，合計超過 1600 人次到訪。自 2024 年起，空間的營運費用，將由 Mozilla 贊助轉為社群自籌，請至
> 
> donate.moztw.space
> 
> 定期定額支持開放自由的摩茲工寮社群空間。

![](/assets/images/miro.medium.com/4160db9fc93a1b1d.jpeg)

> (This is the updated version of
> 
> *this report*
> 
> from 2019. Download the full slide
> 
> *here*
> 
> .
...
It is the first of this kind of Mozilla volunteer-led space. (and another one is [Jakarta Space](http://www.mozilla.or.id/space.html)). These spaces are funded by the Mozilla Participation Team, and managed by local Mozillian volunteers.
...
![](/assets/images/miro.medium.com/a86d170da6b50bed.jpeg)
...
MozTW maintained an online [product portal and forum](https://moztw.org/), hosting [many offline events](https://moztw.org/events/) and engaging with other Asia Mozillians and open-source hackers.

MozTW 的主要任務是維護線上的 [Firefox 產品網站及討論區](https://moztw.org/) 及舉辦 [線下活動](https://moztw.org/events/) 與其他 Mozillians 與開放文化志工與駭客交流。
...
![](/assets/images/miro.medium.com/433921d89d1f311f.jpeg)
...
![](/assets/images/miro.medium.com/aa8bf5bdb89638c4.jpeg)
...
除了 Mozilla 自己的活動以外，我們也支持所有開放文化社群在此舉辦活動與聚會。自 2014 年五月開幕至今，包含 MozTW 在內，總計有 **77** 個開放社群，共在此舉辦了超過**兩千場**活動與聚會，共有超過**兩萬三千名**參加者與訪客。
...
Some of the closest cooperate communities include Rust Taiwan, [G0V](http://g0v.tw/), [OSM](http://openstreetmap.tw/), [Wikimedia Taiwan](https://meta.wikimedia.org/wiki/Wikimedia_Taiwan), [Creative Commons Taiwan](http://creativecommons.tw/%3Cbr%3E), [Ubuntu TW](https://www.ubuntu-tw.org/), [Open Culture Foundation](http://ocf.tw/), [SITCON](http://sitcon.org/) (Students Information Technology Conference), and [COSCUP](http://coscup.org) (Conference for Open Source Coders, Users & Promoters).

在此舉辦活動的開放社群來自非常多領域，包含開放原始碼、程式、至人工智慧、區塊鍊、網路與隱私政策倡議、公民科技與駭客、資訊教育、開放文化、開放資料、多元共融、資安、設計與 Maker 社群等等。

![](/assets/images/miro.medium.com/e4a26fbe1c580838.jpeg)
...
![](/assets/images/miro.medium.com/2fc509f7cb6c873a.jpeg)
...
![](/assets/images/miro.medium.com/bff354c3dcfbc4c9.png)
...
The volunteer keyholders will keep providing the free space to all open culture events & communities, (including open source, open government, open license, and more.) Please support us at [donate.moztw.space](https://donate.moztw.space) ; all the sponsorship will be used for rental and utilities bills.

> 感謝 Mozilla 過去九年半的資助。自 2024 年起，工寮空間的營運費用，將由 MozTW 社群全額自籌。

工寮 keyholder 志工們將繼續提供開放文化相關活動與社群（開放原始碼、開放資料、開放政府、開放授權⋯⋯）免費使用這個空間，也請至 [donate.moztw.space](https://donate.moztw.space/) 定期定額支持我們，款項將全數用於工寮相關支出（租金、水電、網路、清潔）。

[https://donate.moztw.space/](https://donate.moztw.space/)
...
- 閱讀 Mozilla blog 上的社群空間專案介紹
   Read more about the community spaces in 2016 in
...
- 查閱
   活動行事曆
   See if there is any events/opening on
   space calendar
   .
- 歡迎在開放的時間前來參觀（
   Google 地圖
